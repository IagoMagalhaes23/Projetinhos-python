...
cap = cv2.VideoCapture("C:/Users/iagom/OneDrive/Desktop/Speed Detect/vehicle-speed-detection-using-opencv-python/carsVideo.mp4")
f = 25
w = int(1000/(f-1))
...
while True:
    ...
    cv2.line(roi, (0, 40), (320, 40), (0, 0, 255), 2)
    cv2.line(roi, (0, 60), (320, 60), (0, 0, 255), 2)

    cv2.line(roi, (0, 140), (320, 140), (0, 0, 255), 2)
    cv2.line(roi, (0, 160), (320, 160), (0, 0, 255), 2)
